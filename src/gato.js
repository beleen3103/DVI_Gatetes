...
export default class Gato extends Animales {
    ...
    crearAtaques(){
        this.ataque1 = new Ataque(this.scene, 1, 10, 0, 0, false, false, 0, 'zarpazo',90, 430).setInteractive();            
        this.ataque2 = new Ataque(this.scene, -1, -10, 0, 0, false, false, 0, 'afilar', 190, 430).setInteractive();
        this.ataque3 = new Ataque(this.scene, 1, 25, 0, 0, false, false, 0, 'sangrado',290,430).setInteractive();
