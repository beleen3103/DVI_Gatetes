export default class Ini extends Phaser.Scene {
    ...
    create() {
        this.scene.start('pantallaInicio', {x:100,y:0, numeroAnimales: 1, animal1: 'Gato', animal1Vida: 100, animal2: '.', animal2Vida: 0, animal3: '.', animal3Vida: 0, actual: 'Gato', flip: true});
