export default class Ini extends Phaser.Scene {
    ...
    create() {
        ...
        this.scene.start('Callao', {x:100,y:490, numeroAnimales: 1, animal1: 'Gato', animal1Vida: 100, animal2: 'Mapache', animal2Vida: 100, animal3: '.', animal3Vida: 0, actual: 'Gato', flip: true});
    }
}