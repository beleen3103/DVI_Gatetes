...
export default class Mapache extends Animales {
    ...
    crearAtaques(){
        this.ataque1 = new Ataque(this.scene, 1, 25, 0, 0, false, false, 0, 'mordisco',90, 430).setInteractive();
        this.ataque2 = new Ataque(this.scene, -1, -10, 0, 0, false, false, 0, 'curacion', 190, 430).setInteractive();
        this.ataque3 = new Ataque(this.scene, 1, 10, 0, 0, true, false, 0, 'cola',290, 430).setInteractive(); //Cambiar daño a 15
