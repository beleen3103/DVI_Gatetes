...
export default class Rata extends Animales {
    ...
    crearAtaques() {
        this.ataque1 = new Ataque(this.scene, 1, 15, 0, 0, false, false, 0, 'ratamuerde', 90, 430).setInteractive();
        this.ataque2 = new Ataque(this.scene, -1, -10, 0, 0, false, false, 0, 'quesito', 190, 430).setInteractive();
        this.ataque3 = new Ataque(this.scene, 1, 10, 0, 0, false, false, 2, 'multiAtaque', 290, 430).setInteractive();
