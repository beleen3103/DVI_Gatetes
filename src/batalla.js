                ...
                this.listaMalos.children.each(malo => { //cada enemigo ataca
                    ...
                    if(malo.active){ //si no esta muerto ya, ataca
                        ...
                        if(this.ataca < 80) {
                            ...
                            if(!siguenVivos){
                                this.musica1.stop();
                                this.scene.resume(this.escena, {dialogo:false, losed: true, animal1Vida: this.animal1.vida, animal2Vida: this.animal2.vida, animal3Vida: this.animal3.vida}); //vuelve a la escena del mapa aunque desde el principio, no se guarda el estado
                                this.scene.stop()
                            }
